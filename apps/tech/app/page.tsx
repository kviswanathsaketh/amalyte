export default function Home() {
  return (
    <main className="max-w-content mx-auto px-6 py-24">
      ...
      <h1 className="text-display font-display leading-tight text-ink-900">
        We build the systems that run the business.
      </h1>
      <p className="text-body-lg text-ink-700 mt-6 max-w-2xl">
        Amalyte Technologies placeholder home — accent, voice, and motion intensity are scoped
        via the data-property=&quot;tech&quot; attribute on &lt;html&gt;. Real content
