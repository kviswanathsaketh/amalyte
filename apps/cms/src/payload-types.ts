...
export interface User {
  id: number;
  name: string;
  roles: ('admin' | 'editor' | 'staff' | 'hiring_manager')[];
  properties?: ('parent' | 'studio' | 'tech' | 'learn' | 'labs')[] | null;
  updatedAt: string;
  createdAt: string;
  email: string;
...
export interface Page {
  ...
  title: string;
  slug: string;
  property: 'parent' | 'studio' | 'tech' | 'learn' | 'labs';
  content: {
    root: {
      type: string;
      children: {
...
export interface Job {
  ...
  property?: ('parent' | 'studio' | 'tech' | 'learn' | 'labs') | null;
  description: {
    root: {
      type: string;
      children: {
